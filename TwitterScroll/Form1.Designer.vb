...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.NumericUpDownFLClock.Value = New Decimal(New Integer() {1, 0, 0, 0})
        '
        ...
        Me.NumericUpDownClockVL.TabIndex = 135
        Me.NumericUpDownClockVL.Value = New Decimal(New Integer() {1, 0, 0, 0})
        '
        'Label22
        '
